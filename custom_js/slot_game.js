...
window.onload = function () {
    ...
    //拉霸機計分
    const symbolsArray = [
        { src: './img/munchkin.png', alt: '1', magnification: 50, },
        { src: './img/cat.png', alt: '2', magnification: 30 },
        { src: './img/animals.png', alt: '3', magnification: 20 },
        { src: './img/paw.png', alt: '4', magnification: 10 },
    ];
